...
void Equation::setLeftPointX(double x)
{
    Equation::leftPointX = x;
}

void Equation::setRightPointX(double x)
{
    Equation::rightPointX = x;
}

double Equation::getLeftPointX()
{
    return Equation::leftPointX;
}

double Equation::getRightPointX()
{
    return Equation::rightPointX;
}

// проверка интервала
bool Equation::IsIntervalFabs()
{
